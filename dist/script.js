...
/* harmony import */ var _server_server__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../server/server */ "./src/js/server/server.js");
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      Object(_server_server__WEBPACK_IMPORTED_MODULE_3__["postData"])('assets/server.php', formData).then(function (res) {
        console.log(res);
      ...
      var name = a[0].substring(0, 5) + dots + a[1];
...
var filter = function filter() {
  ...
  function bindEventToElem(btn) {
    var mark = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : undefined;
    btn.addEventListener('click', function () {
      typeFilter(mark);
    });
  }

  bindEventToElem(btnAll, markAll);
  bindEventToElem(btnLovers, markLovers);
  bindEventToElem(btnChef, markChef);
  bindEventToElem(btnGirl, markGirl);
  bindEventToElem(btnGuy, markGuy);
  bindEventToElem(btnGrandmother);
  bindEventToElem(btnGranddad);
...
/* harmony import */ var _server_server__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../server/server */ "./src/js/server/server.js");
...
var forms = function forms(state) {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_server_server__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        console.log(res);
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn.addEventListener('click', function () {
    Object(_server_server__WEBPACK_IMPORTED_MODULE_3__["getResource"])('assets/db.json').then(function (res) {
